  ...
  const features = [
    {
      ...
      description:
        "Discover trends and understand your habit patterns at a deeper level.",
      images: [advancedAggAnalyticsScreenshot, keyInsightsIndivdualScreenshot],
    },
    {
      title: "AI Insights and Recommendations",
      description:
        "Our AI analyzes your habits and provides personalized recommendations to improve your success rate.",
      images: [keyInsightsScreenshot, actionableRecommendedScreenshot],
    },
    {
      title: "Habit Correlations and Behavior Patterns",
      description:
        "Learn how your habits influence each other and optimize your daily routine for maximum impact.",
    ...
    <div className="bg-transparent">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4 text-purple-900 dark:text-white">
            Choose Your Plan
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="backdrop-blur-sm bg-white/30 dark:bg-gray-900/30 rounded-2xl p-8">
            ...
            <div className="text-4xl font-bold mb-8 md:mb-[60px] dark:text-white">
              $0
            </div>
            <Link
              to="/signup"
          ...
          <div className="backdrop-blur-sm bg-white/30 dark:bg-gray-900/30 rounded-2xl p-8 border-2 border-purple-500 relative">
            ...
            <div className="mb-8 text-sm text-gray-600 dark:text-gray-300">
              or $19.99/year{" "}
              <span className="text-emerald-500 font-semibold">(save 16%)</span>
            </div>
            <Link
              to="/signup"
                  ...
                  return (
                    <li key={index} className="flex items-center gap-2">
                      ...
                      >
                        {feature.name}{" "}
                        {feature.ai ? (
                          <SparklesIcon className="w-4 h-4 text-fuchsia-500 dark:text-fuchsia-400" />
                        ) : (
                          ""
                        )}
                      </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center text-white">
            <div>
              ...
              <div className="text-purple-100">
                Track your habits with family and friends
              </div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">
            ...
            <div>
              ...
              <div className="text-purple-100">
                Detailed analytics to understand your behavior
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-purple-100 mb-12 max-w-2xl mx-auto">
            Begin with our free plan and upgrade whenever you're ready. No
