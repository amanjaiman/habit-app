...
export default function Calendar() {
  ...
  return (
    <div className="space-y-6">
      <div
        className="flex flex-col sm:flex-row items-center justify-between backdrop-blur-sm bg-white/30 
        ...
        <div className="flex items-center space-y-0 space-x-4">
          <Listbox value={viewType} onChange={setView}>
            <div className="relative z-[200]">
              <Listbox.Button
                className="relative w-40 px-4 py-2 rounded-lg border-0 
                      ...
                      <>
                        ...
                        >
                          ...
                          {option.premium && !premium && (
                            <span className="ml-2">
                              <LockClosedIcon
                                className="h-5 w-5 fill-purple-600 dark:fill-purple-400"
                                aria-hidden="true"
                              />
                            </span>
                          )}
      ...
      <div
        className="backdrop-blur-sm bg-white/30 dark:bg-gray-900/30 rounded-xl 
