  ...
  return (
    <main className="max-w-7xl mx-auto py-6 px-4 sm:px-8 lg:px-12">
      <div className="space-y-8">
        {/* Header Section */}
        <div
          className="flex flex-row justify-between items-center backdrop-blur-sm bg-white/30 dark:bg-gray-900/30 
                      rounded-2xl p-4 sm:p-8 border border-white/20 dark:border-gray-800/30 shadow-xl"
        >
          <div>
            <h1
              className="sm:text-start text-2xl sm:text-4xl leading-[3rem] font-black bg-gradient-to-r from-purple-600 to-pink-600 
